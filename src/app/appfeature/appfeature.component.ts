...
export class AppfeatureComponent implements OnInit {
  ...
  async ngOnInit() {
      ...
      switch (this.arrAppFeatureJSON[i].status) {
        case "ACTIVE":
          ...
          for (var f = 0; f < this.arrAppFeatureJSON[i].features.length; f++) {
            ...
            console.log(this.arrAppFeatureJSON[i].features[f]);
            //this.arrSingleAppFeatures = this.arrAppFeatureJSON[i].features.split(',')
            // this.arrSingleAppFeatures = this.arrAppFeatureJSON[f].features;
            //  console.log(this.arrSingleAppFeatures);
             for (var it = 0; it < this.arrAppFeatureJSON[it].features.length; it++) {
                 console.log( this.arrAppFeatureJSON[i].features[it]);
              }
    ...
    // console.log(this.arrAppFeatureJSON[7].features);
    ...
    //console.log(this.barChartData7[0]);
  }
